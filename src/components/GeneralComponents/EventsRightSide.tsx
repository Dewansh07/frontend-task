  ...
  return (
    <div className="lg:-ml-6 xl:ml-0">
      ...
      <div className="flex flex-col gap-8 mt-10 lg:mt-8 xl:mt-12">
        <p className="font-extrabold text-3xl sm:text-4xl lg:text-5xl 2xl:text-[57px] leading-[62px]">
          Event Name
        </p>
        <div className="flex gap-8 lg:gap-4 xl:gap-8">
          <div className="flex items-center lg:gap-2 xl:gap-4">
            <LocationSVG />
            <p className="text-white text-base sm:text-[22px] lg:text-lg xl:text-[22px] font-semibold">
              Venue
            </p>
          </div>
          <div className="flex items-center gap-4 lg:gap-2 xl:gap-4">
            <AlarmSVG />
            <p className="text-white text-base sm:text-[22px] lg:text-lg xl:text-[22px] font-semibold lg:text-nowrap">
              04/3/2024 @19:00
            </p>
          </div>
        </div>
        <p className="text-sm sm:text-base font-medium lg:w-10/12 xl:w-9/12">
        ...
        <div className="flex mt-8 w-full lg:w-fit">
          <div  className="w-1/3 h-[130px] xs:h-[160px] sm:h-[250px] lg:h-[120px] lg:w-[120px] xl:h-[140px] xl:w-[140px] 2xl:h-[180px] 2xl:w-[180px] relative">
            <Image src={"/images/artist-three.png"} alt={`artist-one`} fill />
          </div>
          <div  className="w-5/12 sm:w-1/3 h-[130px] xs:h-[160px] sm:h-[250px] lg:h-[120px] lg:w-[120px] xl:h-[140px] xl:w-[140px] 2xl:h-[180px] 2xl:w-[180px] z-10 scale-125 relative">
